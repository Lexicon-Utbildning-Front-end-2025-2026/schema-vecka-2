...
* **[Måndag](https://github.com/Lexicon-Utbildning-Front-end-2025-2026/lektion-5-jan)** (Maja) - **TypeScript – Intro** Översikt TS vs JS, felsökning i DevTools, initiera projekt med `npm` & `tsc`, första enkla exempel.* **Röd dag**
